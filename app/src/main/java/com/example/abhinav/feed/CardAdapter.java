package com.example.abhinav.feed;
        ...
        public ViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   ...
                   // Intent i =new Intent(itemView.getContext(),ScrollingActivity.class);
                   // itemView.getContext().startActivity(i);

                    itemView.getContext().startActivity(new Intent(itemView.getContext(),ScrollingActivity.class));
